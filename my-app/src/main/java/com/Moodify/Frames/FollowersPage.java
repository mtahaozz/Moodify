 ...
 * @author ArdaS
 */
public class FollowersPage extends javax.swing.JFrame {

    /**
     * Creates new form FollowersPageN
     */
    String accessToken;
    public FollowersPage(String accessToken) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FollowersPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FollowersPage("a").setVisible(true);
            }
        });
    }
